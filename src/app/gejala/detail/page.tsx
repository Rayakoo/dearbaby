      ...
      <main className="w-full max-w-4xl mx-auto px-4 mt-4">
        ...
        <section className="mb-6 bg-white p-6 rounded-lg shadow-sm">
          <p className="text-gray-700 leading-relaxed">
            Sakit kepala adalah keluhan umum yang dialami ibu hamil, terutama di trimester
            ketiga. Ini terjadi karena perubahan hormon, dehidrasi, kurang tidur, atau stres yang mempengaruhi tubuh.
          </p>
        </section>
        ...
        {/* Daftar Penyebab (Konten tab yang aktif saat ini) */}
        <section>
          <CardDetailGejala
            iconSrc="/image/perubahan-hormon.jpg" // Ganti dengan path ikon Anda
          ...
          />
          <CardDetailGejala
            iconSrc="/image/dehidrasi.jpg" // Ganti dengan path ikon Anda
            title="Dehidrasi"
            description="Kurangnya asupan cairan dapat menyebabkan dehidrasi dan memicu sakit kepala."
          />
          <CardDetailGejala
            iconSrc="/image/kurnag-tidur.jpg" // Ganti dengan path ikon Anda
            title="Kurang tidur"
