...
export default function CardRS({
  ...
  return (
    <Link href="/beranda/fasilitas-kesehatan/detail" className="block">
      <div className="flex flex-col md:flex-row justify-between items-start bg-white rounded-2xl shadow-md p-6 border border-gray-200 gap-4 md:gap-6 cursor-pointer hover:shadow-xl transition">
